...
var appMiddleware = __webpack_require__(126);

appMiddleware(app);

var appRouting = __webpack_require__(129);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(24).concat(__webpack_require__(36)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(37).concat(__webpack_require__(84)) },
...
var onFinished = __webpack_require__(18)
var parseUrl = __webpack_require__(14)
var statuses = __webpack_require__(99)
var unpipe = __webpack_require__(38)
...
var onFinished = __webpack_require__(18);
var path = __webpack_require__(1);
var statuses = __webpack_require__(121)
var merge = __webpack_require__(22);
...
var cors = __webpack_require__(127);

function appMiddleware(app) {
  // Middleware for Static File - https://expressjs.com/en/starter/static-files.html
  // app.use('/static', express.static(path.resolve(__dirname, 'public')));
  var publicPath = path.resolve('server/public');
  console.log('publicPath: ', publicPath);
  app.use('/static', express.static(publicPath)); // https://medium.com/@adamzerner/how-bodyparser-works-247897a93b90
  // JSON Request: https://stackoverflow.com/a/10007542

  app.use(bodyParser()); // Form Data: https://stackoverflow.com/a/38763341
...
/* WEBPACK VAR INJECTION */(function(__dirname) {function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }
...
var filePath = path.resolve(__dirname, '../../server-dist/tasks.json');
var taskList = [];
...
function appRouting(app) {
  ...
  app.put('/api/task/update/:id/:title/:completed', function (req, res) {
    ...
    function updateTask() {
      if (!Number.isNaN(id)) {
        var task = taskList.find(function (item) {
          return item.id === id;
        });
        console.log(task);
        console.log('delete');
        ...
        if (task !== null) {
          ...
          fs.writeFile(filePath, JSON.stringify(taskList, null, 2), function (err) {
            if (err) {
              console.log('error writting to file');
              throw err;
            } else {
  ...
  app.post('/api/task/create/:title', function (req, res) {
    console.log(req.params);
    ...
    function addTask() {
      var oldId = Math.max.apply(Math, _toConsumableArray(taskList.map(function (o) {
        return o.id;
      })));
      var newId = (taskList.length === 0 ? 0 : oldId) + 1;
      console.log(newId);
      var task = {
        id: newId,
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(55);
